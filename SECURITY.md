# Security Policy for the Date::Ethiopic distribution.

Report issues via email at: Daniel Yacob <dyacob@cpan.org>.


This is the Security Policy for `Date::Ethiopic`.

The latest version of the Security Policy can be found in the
[git repository for Date::Ethiopic](https://github.com/dyacob/Date-Ethiopic/blob/main/SECURITY.md).
...
a GitHub account, please open an [issue](https://github.com/dyacob/Date-Ethiopic/issues) and
...
Any security vulnerabilities in `Date::Ethiopic` are covered by this policy.
